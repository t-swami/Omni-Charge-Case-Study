...
public class SwaggerConfig {
    ...
    @Value("${swagger.direct.url:http://localhost:8084}")
    ...
    public OpenAPI paymentServiceOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("OmniCharge - Payment Service API")
                .version("1.0")
            ...
            .addServersItem(new Server().url(directUrl).description("Direct - Payment Service"))
